...
//className in karşılığı fill-curent 
//fill current className=w-7 h-7  kısmındaki tüm class özelliklerini birleştirmek için ({className}) kullanılır
...
//icon - g-path
// className de w-7 h-7 şeklinde özellikleri ayrı veriririz çünkü tüm iconların aynı boyutta olmasını istemiyoruz
//fill-current className e verilen renk özellğinin tüm iconlara uygulanmasını sağlar
//export const HomeIcon Sidebar da import  edilmeli
