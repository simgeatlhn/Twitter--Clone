...
import { ReplyIcon, ReTweetIcon, ShareIcon, LikeIcon } from "../icons/Icon";

//feedList.js parent , feedItem.js child
//timestamp? soru işaretinin anlamı tarih yoksa hata vermemesi için
//toLocale ile TR seçildi
//flex-1 contentin tamamını kapsaması için

const FeedItem = ({
    avatar, content, displayName, image, timestamp, username
}) => {
    return (
        <article className="flex space-x-3 border-b border-gray-extraLight px-4 py-3 cursor-pointer">
            ...
            <div className="flex-1">
                ...
                {/* //eğer atılan twette image varsa eklenir şart durumu */}
                ...
                <ul className="-ml-1 mt-3 flex justify-between max-w-md">
                    <li className="flex items-center space-x-3 text-gray-dark text-sm group">
                        <div className="flex item-center justify-center w-8 h-8 rounded-full group-hover:bg-primary-light">
                    ...
                    <li className="flex items-center space-x-3 text-gray-dark text-sm group">
                        <div className="flex item-center justify-center w-8 h-8 rounded-full group-hover:bg-green-200">
